...
def build_scenario_section(config, **kwargs) -> Section:
    lines = [
        ...
        f"  {t('scenario', 'start_time'):<20}: {config.start_time} (auto)",
    ...
    field_map = [
        ...
        FieldMeta("start_time", t('scenario', 'start_time'), False, 5),
...
SCENARIO_SECTION = build_scenario_section(
    type("_Cfg", (), {
        ...
        "start_time": "auto (set on Ctrl+R)", "planned_duration": "00:30:00",
        "output": type("_Out", (), {
